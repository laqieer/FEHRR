...
#define JID_フレイヤ JID_MANAKETE
#define JID_セイズ JID_VALKYRIE
#define JID_スルト JID_GENERAL
#define JID_アシュ JID_MANAKETE
#define JID_神階アスク JID_MANAKETE
#define JID_リーヴ JID_SWORDMASTER
#define JID_レーギャルン JID_WYVERNLORD_F
#define JID_ダグ JID_WARRIOR
#define JID_エイトリ JID_SAGE
#define JID_レーヴァテイン JID_SWORDMASTER_F
